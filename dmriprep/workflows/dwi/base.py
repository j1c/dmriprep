...
def init_dwi_preproc_wf(
    ...
    if not os.path.isdir(subdir):
        os.mkdir(subdir)
    sesdir = "%s%s%s%s%s" % (out_dir, "/sub-", sub, "/ses-", ses)
    ...
    register_to_eddy_out._mem_gb = 2
    ...
    if denoise_strategy == 'nlsam':
        ...
        denoise_node._mem_gb = omp_nthreads*2
...
def init_base_wf(
    ...
    if len(sessions) > 1:
        ...
        if len(bids_dict[participant][session].keys()) == 1:
            ...
            wf.get_node(wf_dwi_preproc.name).get_node('check_orient_and_dims_dwi_node')._mem_gb = 10
            wf.get_node(wf_dwi_preproc.name).get_node('correct_vecs_and_make_b0s')._mem_gb = 10
            wf.get_node(wf_dwi_preproc.name).get_node('bet_pre_moco')._mem_gb = 10
            ...
            wf.get_node(wf_dwi_preproc.name).get_node('make_gtab')._mem_gb = 10
            wf.get_node(wf_dwi_preproc.name).get_node('extract_metadata')._mem_gb = 5
            wf.get_node(wf_dwi_preproc.name).get_node('check_shelled')._mem_gb = 5
            wf.get_node(wf_dwi_preproc.name).get_node('get_topup_inputs')._mem_gb = 5
            wf.get_node(wf_dwi_preproc.name).get_node('get_eddy_inputs')._mem_gb = 5
            wf.get_node(wf_dwi_preproc.name).get_node('make_mean_b0')._mem_gb = 10
            wf.get_node(wf_dwi_preproc.name).get_node('make_basename')._mem_gb = 5
            wf.get_node(wf_dwi_preproc.name).get_node('eddy_quad')._mem_gb = 24
            wf.get_node(wf_dwi_preproc.name).get_node('eddy_quad').interface._mem_gb = 24
            wf.get_node(wf_dwi_preproc.name).get_node('make_gtab_final')._mem_gb = 10
            wf.get_node(wf_dwi_preproc.name).get_node('apply_mask')._mem_gb = 10
            wf.get_node(wf_dwi_preproc.name).get_node('apply_mask').interface._mem_gb = 10
            wf.get_node(wf_dwi_preproc.name).get_node('apply_mask_final')._mem_gb = 10
            wf.get_node(wf_dwi_preproc.name).get_node('apply_mask_final').interface._mem_gb = 10
            wf.get_node(wf_dwi_preproc.name).get_node('id_outliers_from_eddy_report')._mem_gb = 10
            wf.get_node(wf_dwi_preproc.name).get_node('drop_outliers_from_eddy_report')._mem_gb = 24
            ...
            if denoise_strategy == 'nlsam':
                ...
                wf.get_node(wf_dwi_preproc.name).get_node('denoise')._mem_gb = omp_nthreads*2
...
def wf_multi_session(bids_dict,
    ...
    if len(bids_dict[participant][sessions[0]].keys()) == 1:
        ...
        wf_multi.get_node(wf.name).get_node('register_to_eddy_out').interface._mem_gb = 2
        wf_multi.get_node(wf.name).get_node('register_to_eddy_out')._mem_gb = 2
        ...
        wf_multi.get_node(wf.name).get_node('Bias_b0')._mem_gb = omp_nthreads*2
        wf_multi.get_node(wf.name).get_node('Bias_b0').interface.n_procs = omp_nthreads
        wf_multi.get_node(wf.name).get_node('Bias_b0').interface.mem_gb = omp_nthreads*2
        ...
        if denoise_strategy == 'nlsam':
            ...
            wf_multi.get_node(wf.name).get_node('denoise')._mem_gb = omp_nthreads*2
        ...
        wf_multi.get_node(wf.name).get_node(wf_dwi_preproc.name).get_node('register_to_eddy_out').interface._mem_gb = 2
        wf_multi.get_node(wf.name).get_node(wf_dwi_preproc.name).get_node('register_to_eddy_out')._mem_gb = 2
        ...
        wf_multi.get_node(wf.name).get_node(wf_dwi_preproc.name).get_node('Bias_b0')._mem_gb = omp_nthreads*2
        wf_multi.get_node(wf.name).get_node(wf_dwi_preproc.name).get_node('Bias_b0').interface.n_procs = omp_nthreads
        wf_multi.get_node(wf.name).get_node(wf_dwi_preproc.name).get_node('Bias_b0').interface.mem_gb = omp_nthreads*2
        ...
        if denoise_strategy == 'nlsam':
            ...
            wf_multi.get_node(wf.name).get_node(wf_dwi_preproc.name).get_node('denoise')._mem_gb = omp_nthreads*2
